<template>
  <SidebarContextRootContainer>
    <template #title>
      ...
      <p class="font-medium text-[#1874FF] text-sm mt-2.5">
        Created by the Ubituity Team
      </p>
      <div
        class="
          flex-shrink-0
    ...
    <div class="bg-[#C5CCE1] bg-opacity-[0.15] mt-10 p-8">
        ...
        <template #trigger="{ toggle }">
          <div class="flex">
            ...
            >
              ...
              />
              <span class="text-primary-blue-dark mr-2.5 text-sm font-semibold">
                {{ token0.symbol }}
              </span>
              <svg
                width="9"
            ...
            <p class="flex leading-[52px] text-xs ml-2.5">
            ...
            >
              <template v-slot:default="{ item }">
                ...
                >
                  ...
                  <span class="text-primary-blue-dark text-sm font-semibold">
                    {{ item.symbol }}
                  </span>
                </div>
              </template>
      ...
      <div class="flex items-center">
        ...
        <div class="flex flex-col mx-2">
          <div class="mb-1 font-medium leading-none whitespace-no-wrap text-15">
            {{ uadcrv3.usd }}
          </div>
          <div class="flex leading-none whitespace-no-wrap">
            <span class="text-grey-pure text-11 leading-[17px]">{{
              uadcrv3.lp
            }}</span>
      ...
      >
        ...
        <div class="flex flex-col mx-1">
          <div class="mb-0 font-medium leading-none whitespace-no-wrap text-12">
            {{ uadcrv3Add.usd }}
          </div>
          <div class="flex leading-none whitespace-no-wrap">
...
export default defineComponent({
  ...
  setup() {
    ...
    const token0 = reactive({
      ...
      amountUSD: computed(
        () =>
          prices[activeNetworkId.value][token0.address] * token0.amount || "0"
      ),
    ...
    const formatNumber18 = (value) =>
      formatNumber(ensureValue(value).dividedBy(1e18).toFixed());
